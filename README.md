...
* `DARE-FRAMEWORK_v1.pdf` – framework version 1
* `DARE-FRAMEWORK_v2.pdf` – framework version 2
...
The bibliography file `DARE-LITERATURE.bib` contains the references used in the literature review.
